...
class Animate {
    ...
    add(container, className) {
        let events = "webkitAnimationEnd";
        var dtd = new Promise(function(resolve, reject) {
            $(container).addClass(className).once(events, function() {
    ...
    moveIn(containerNow, containerNew) {
        var classNow = "slideOutLeft";
        var classNew = "slideInRight";
        return Promise.all([this.add(containerNow, classNow), this.add(containerNew, classNew)]);
    }
    moveOut(containerNow, containerNew) {
        var classNow = "slideOutRight";
        var classNew = "slideInLeft";
        return Promise.all([this.add(containerNow, classNow), this.add(containerNew, classNew)]);
    }
}
