...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/packages/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
var proxy = _index2.default.proxy,
    EventBase = _index2.default.EventBase;
...
var Drag = function (_EventBase) {
    (0, _inherits3.default)(Drag, _EventBase);
    ...
    function Drag(opts) {
        ...
        _this.$options = (0, _assign2.default)(opts, _this.defaultOption());
        var keys = (0, _keys2.default)(_this.$options);
        var self = _this;
    ...
    (0, _createClass3.default)(Drag, [{
        ...
        value: function dragStartHandler(e) {
            ...
            var mousemoveDelegate = function mousemoveDelegate(e) {
                _this3.dragUpdateHandler(e);
            };
            var mouseupDelegate = function mouseupDelegate(e) {
                _this3.dragCompletedHandler(e);
            };
        ...
        value: function dragCompletedHandler(e, missed) {
            // 防止多次触发
            if (this.mouseHandler) {
        ...
        key: "updateMouseInfo",
        value: function updateMouseInfo(e) {
            var mouse = this.mouse;
...
var _drag = __webpack_require__(/*! ./drag.js */ "./src/packages/drag.js");

var _drag2 = _interopRequireDefault(_drag);

var _listGroup = __webpack_require__(/*! ./listGroup.js */ "./src/packages/listGroup.js");

var _listGroup2 = _interopRequireDefault(_listGroup);

var _svg = __webpack_require__(/*! ./svg.js */ "./src/packages/svg.js");

var _svg2 = _interopRequireDefault(_svg);

var _typewriter = __webpack_require__(/*! ./typewriter.js */ "./src/packages/typewriter.js");
...
var ListGroup = function (_EventBase) {
    (0, _inherits3.default)(ListGroup, _EventBase);
    ...
    function ListGroup(opts) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (ListGroup.__proto__ || (0, _getPrototypeOf2.default)(ListGroup)).call(this));
...
var Svg = function () {
    ...
    function Svg(opts) {
        ...
        this.$options = (0, _assign2.default)(opts, this.defaultOption());
    ...
    (0, _createClass3.default)(Svg, [{
        ...
        key: "create",
        value: function create(name, data, parent, child) {
            name = name || "g";
...
var typewriter = function () {
    ...
    function typewriter(opts) {
        ...
        (0, _classCallCheck3.default)(this, typewriter);
        ...
        this.progress = 0;
        this.$options = opts.map(function (item) {
            var o = (0, _assign2.default)(item, _this.defaultOption());
            o.id = GUID++;
            return o;
        });
        var autoTypeWriter = /*#__PURE__*/_regenerator2.default.mark(function autoTypeWriter() {
            var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _opts;

            return _regenerator2.default.wrap(function autoTypeWriter$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.prev = 3;
                            _iterator = (0, _getIterator3.default)(this.$options);
            ...
            }, autoTypeWriter, this, [[3, 14, 18, 26], [19,, 21, 25]]);
        });
        var g = autoTypeWriter.apply(this);
        this.run(g);
    }

    (0, _createClass3.default)(typewriter, [{
        key: 'defaultOption',
        value: function defaultOption() {
            return {
                speed: 16,
        ...
        key: 'writeFlow',
        value: function writeFlow(opts) {
            var _this2 = this;

            return new _promise2.default(function (resolve, reject) {
                _this2.progress = 0;
                _this2.writeTo(opts, resolve, reject);
            });
        }
    }, {
        key: 'writeTo',
        value: function writeTo(o, resolve, reject) {
            var _this3 = this;

            var storageId = o.id;
            var content = o.content;
            var charsPerInterval = o.charsPerInterval;
            var progress = this.progress;
            var message = stringStorage[storageId] || "";
            var chars = content.slice(progress, progress + charsPerInterval);
            message += chars;
            ...
            setTimeout(function () {
                var isEnd = progress >= content.length;
                var input = message + (progress & 1 && !isEnd ? '_' : ''); //奇偶判断
                o.$el.innerHTML = input;
                if (!isEnd) {
                    _this3.writeTo(o, resolve, reject);
                } else {
                    resolve();
                }
            }, o.speed);
