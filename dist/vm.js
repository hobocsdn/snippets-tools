...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/vm/vm.js");
/******/ })
/************************************************************************/
/******/ ({
...
exports.EventBase = exports.Event = undefined;
...
var removeEventByNameSpace = function removeEventByNameSpace(eventListeners, namespace) {
    var types = (0, _keys2.default)(eventListeners);
...
var getEventList = function getEventList(types, handler, option) {
    if (handler && (typeof handler === "undefined" ? "undefined" : (0, _typeof3.default)(handler)) === "object") {
        option = handler;
    }
    var eventList = [];
...
var EventBase = exports.EventBase = function () {
    ...
    (0, _createClass3.default)(EventBase, [{
        ...
        value: function extend() {
            ...
            _assign2.default.apply(Object, [this].concat(args));
        }
    }]);
    return EventBase;
}();
...
var Util = {
    extend: function extend() {
        _assign2.default.apply(Object, arguments);
    }
};
...
var WebContextInfo = function () {
    function WebContextInfo() {
        (0, _classCallCheck3.default)(this, WebContextInfo);
    ...
    (0, _createClass3.default)(WebContextInfo, [{
        key: "url",
        value: function url() {
...
var log4j = function () {
    function log4j() {
        ...
        (0, _classCallCheck3.default)(this, log4j);
...
var Dep = function () {
    ...
    (0, _createClass3.default)(Dep, [{
        ...
        value: function removeSub(watcher) {
            ...
            if (subs.length) {
                var index = subs.indexOf(watcher);
                if (index > -1) {
...
var _dep = __webpack_require__(/*! ./dep.js */ "./src/vm/dep.js");
...
function defineReactive(obj, key, val) {
    var dep = new _dep2.default(); //订阅管理类
    ...
    (0, _defineProperty2.default)(obj, key, {
        ...
        get: function reactiveGetter() {
            ...
            var watcher = _dep2.default.target;
            if (watcher) {
                dep.depend();
                if (childOb) {
                    childOb.dep.depend();
...
var _observe = __webpack_require__(/*! ./observe.js */ "./src/vm/observe.js");

var _observe2 = _interopRequireDefault(_observe);

var _watcher = __webpack_require__(/*! ./watcher.js */ "./src/vm/watcher.js");

var _watcher2 = _interopRequireDefault(_watcher);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var isPlainObject = _index2.default.isPlainObject,
    isFunction = _index2.default.isFunction,
    isString = _index2.default.isString,
    noop = _index2.default.noop;
...
var VM = function (_EventBase) {
    (0, _inherits3.default)(VM, _EventBase);

    function VM() {
        var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        (0, _classCallCheck3.default)(this, VM);

        var _this = (0, _possibleConstructorReturn3.default)(this, (VM.__proto__ || (0, _getPrototypeOf2.default)(VM)).call(this));

        _this.$options = opts;
        // 设置代理并观察对象
        opts.data && _this.initData(_this);
        opts.watch && _this.initWatch(_this, opts.watch);
        return _this;
    }

    (0, _createClass3.default)(VM, [{
        key: 'initData',
        ...
        value: function initWatch(vm, watch) {
            var keys = (0, _keys2.default)(watch);
            keys.forEach(function (key, index) {
        ...
        key: '$watch',
        value: function $watch(vm, key, handler) {
            var options = handler;
            var cb = void 0;
            ...
            var watcher = new _watcher2.default(vm, key, cb, options);
...
var _dep = __webpack_require__(/*! ./dep */ "./src/vm/dep.js");
